...
urlpatterns = [
    ...
    path("services/", views.critical_services, name="critical-services"),
    path("bia/", views.bia_profiles, name="bia-profiles"),
    path("hazards/", views.hazards, name="hazards"),
    path("hazards/new/", views.hazard_detail, name="hazard-new"),
    path("hazards/<int:hazard_id>/", views.hazard_detail, name="hazard-detail"),
    path("scenarios/", views.scenarios, name="scenarios"),
    path("continuity/", views.continuity_strategies, name="continuity-strategies"),
