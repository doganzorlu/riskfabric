...
### Egitim Modulu 1: Varlik Kritiklik ve Envanter Kalitesi

Amac: Varliklari is etkisine gore siniflandirmayi ogretmek.

Notlar:
- Varlik envanterindeki eksik alanlari tespit et.
- Kritiklik kriterlerini (gelir, operasyon, uyumluluk) tanimla.
- Kritik varliklarin bagimliliklarini yaz.

Egzersiz:
- Iki kritik varlik sec ve kritiklik gerekcesini yaz.
- Her biri icin 1 KRI belirle.

Sik hatalar:
- Kritiklik vermeden once bagimliliklari incelememek.
- Kriterleri belgelememek.

### Egitim Modulu 2: Risk Cumlesi ve Skorlama Kalibrasyonu

Amac: Net risk cumlesi yazma ve skor tutarliligi saglama.

Notlar:
- Neden-olay-etki yapisini kullan.
- Olasilik ve etki icin kanit topla.
- Skor yontemi agirliklarini kontrol et.

Egzersiz:
- Uc risk cumlesi yaz ve skorla.
- Skor kararinin gerekcesini ekle.

Sik hatalar:
- Etkiyi abartmak veya kucumsemek.
- Skor kararini kanitsiz vermek.

### Egitim Modulu 3: Azaltma Plani ve Takvimleme

Amac: Gercekci azaltma planlari olusturmayi ogretmek.

Notlar:
- Azaltma tipini sec (kacin, azalt, aktar, kabul).
- Sorumlu ve zaman planini tanimla.
- Beklenen etkinligi yuzde olarak belirt.

Egzersiz:
- Bir risk icin azaltma plani olustur.
- Aksiyonlari kilometre taslarina bol.

Sik hatalar:
- Sorumlu atamamak.
- Gercek disi tarih vermek.

### Egitim Modulu 4: Zafiyetlerden Riski Turetme

Amac: Zafiyetlerin riske nasil donusturulecegini ogretmek.

Notlar:
- Zafiyetleri varliklarla esle.
- Zafiyet siddetini risk olasiligi ile iliskilendir.
- Gerekirse yeni risk olustur.

Egzersiz:
- Bir zafiyet icin risk kaydi olustur.
- Mevcut kontrollerin etkisini acikla.

Sik hatalar:
- Zafiyeti riskten bagimsiz birakmak.
- Mevcut kontrolleri yok saymak.

### Egitim Modulu 5: Uyumluluk ve Kontrol Testi

Amac: Kontrol testlerinin uyumluluga etkisini gostermek.

Notlar:
- Bir uyumluluk cercevesi sec.
- Gereksinimlere kontrol bagla.
- Kontrol test plani ve calismasi olustur.

Egzersiz:
- Bir kontrol testi calistir ve kanit ekle.
- Test sonucunu rapora yansit.

Sik hatalar:
- Kanit eklememek.
- Test prosedurunu belirsiz birakmak.
...
### Vaka Calismasi 6: ISO 27001 Kontrol Kanit Acigi

Baglam: Denetimde erisim loglama kontrolu icin kanit eksigi bulundu.

Adimlar:
- Kontrol gereksinimini cerceveye bagla.
- Kontrol test plani ve calismasi olustur.
- Eksik kanitlari topla ve iyilestirme yaz.
- 30 gun icinde tekrar test planla.

Sonuc: Tekrar testte kontrol gecti.

### Vaka Calismasi 7: Bulut Maliyet Asimi

Baglam: Bulut harcamalari beklenmedik sekilde %30 artis gosterdi.

Adimlar:
- Bulut platformunu varlik olarak kaydet.
- Trend verisiyle finansal risk olustur.
- Azaltma: maliyet limitleri ve alarmlar.
- Aylik gozden gecirme ve KPI raporu ekle.

Sonuc: Iki ayda butce icine donuldu.

### Vaka Calismasi 8: ERP Erisim Gozden Gecirme Aksagi
...
### Vaka Calismasi 9: Yamalanmamis OT Sistemleri
...
### Vaka Calismasi 10: Ucuncu Taraf Lojistik Kesintisi
...
### Vaka Calismasi 11: Veri Merkezi Enerji Dengesizligi
...
### Vaka Calismasi 12: Kimlik Avciligi Kampanyasi
...
### Vaka Calismasi 13: ISO 27001 Kontrol Kanit Acigi
...
### Vaka Calismasi 14: Bulut Maliyet Asimi
...
### Vaka Calismasi 15: ERP Erisim Gozden Gecirme Aksagi
...
### Vaka Calismasi 16: Yamalanmamis OT Sistemleri
...
### Vaka Calismasi 17: Ucuncu Taraf Lojistik Kesintisi
...
### Vaka Calismasi 18: Veri Merkezi Enerji Dengesizligi
...
### Vaka Calismasi 19: Kimlik Avciligi Kampanyasi
...
### Vaka Calismasi 20: ISO 27001 Kontrol Kanit Acigi
